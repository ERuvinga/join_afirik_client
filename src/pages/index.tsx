    ...
    <>
      ...
      <div className='w-[100%] md_lg:[90%] mx-auto py-4 flex flex-col md:flex-row md:justify-between'>
        ...
        <div className=' w-[100%] w-[90%] md:w-[85%] mx-auto'>
          <div className=' w-[100%] h-[100px] flex items-center justify-between md_lg:justify-start '>
            <span className='text-[#8186A0]  text-[.8em] font-bold md_lg:pr-32'>Trouvez un travail</span>
            <ShowFilter />
          </div>
          <div className=' w-[100%] mx-auto flex flex-col-reverse justify-center md_lg:flex-row '>
            ...
            <div className='border flex flex-col py-2 items-center justify-between md_lg:flex-col md_lg:w-[25%] md_lg:items-center space-y-2'>
              <div className='blocFilter w-[95%] px-4 pt-4 pb-4 md_lg:pt-8 md_lg:pb-1 pb-2 flex flex-col space-y-3 border'>
                <input type='text' placeholder='Trouver un travail' className=' w-[30%] searcWorkField text-[.6em] md_lg:w-[80%] h-[22px] px-2' />
                <div className='flex  items-center justify-between md_lg:flex-col md_lg:items-start'>
                  <div className=''>
              ...
              <div className=' blocFilter w-[95%] px-4 py-3 flex justify-between md_lg:flex-col md_lg:space-y-3 border'>
                <div className=''>
                  ...
                  <div className=' mt-2 flex items-center space-x-2 justify-between'>
                    <select className=' font-semibold:w-[85px] text-[.5em] text-[#8186A0] font-semibold'>
                ...
                <div className='p-2 border md_lg:p-0'>
